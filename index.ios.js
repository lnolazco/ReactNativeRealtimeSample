...
var RealtimeRCT = React.createClass({ 
  ...
  doConnect: function(){
    ...
    RCTRealtimeMessaging.RTConnect(
    {
      ...
      connectionMetadata:this.state.token,
  ...
  getDataSource: function(messages) {
...
AppRegistry.registerComponent('ReactNativeRealtimeSample', () => RealtimeRCT);
...
// export default class ReactNativeRealtimeSample extends Component {
//   render() {
//     return (
...
// AppRegistry.registerComponent('ReactNativeRealtimeSample', () => ReactNativeRealtimeSample);
